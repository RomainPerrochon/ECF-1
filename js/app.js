...
addMovieForm.addEventListener("submit", (e) => {
  ...
  // Pour l’auteur, on met juste la première lettre globale en majuscule,
  // et on garde le reste tel quel (exigence: première lettre en MAJUSCULE)
  const auteur = capitalizeFirstLetter(auteurRaw);

  movies.push({ titre, annee, auteur });

  // Tri automatique selon l’option sélectionnée après ajout
  sortMovies();
